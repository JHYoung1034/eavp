...
> 状态：稳定基线为 Media Backend Foundation 0.2；0.3a Linux Runtime/V4L2 与 0.3b ALSA 采集开发能力已完成验收\
> 适用版本：0.2.0 之后\
> 规范性范围：里程碑顺序，不冻结接口
